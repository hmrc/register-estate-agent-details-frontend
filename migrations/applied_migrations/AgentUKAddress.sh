...
echo "agentUKAddress.field1 = field1" >> ../conf/messages.en
echo "agentUKAddress.field2 = field2" >> ../conf/messages.en
...
awk '/class/ {\
     ...
     print "    x =>";\
     print "      AnswerRow(";\
     print "        HtmlFormat.escape(messages(\"agentUKAddress.checkYourAnswersLabel\")),";\
