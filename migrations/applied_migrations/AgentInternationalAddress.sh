...
echo "GET        /agentInternationalAddress                        controllers.AgentInternationalAddressController.onPageLoad(mode: Mode = NormalMode)" >> ../conf/app.routes
echo "POST       /agentInternationalAddress                        controllers.AgentInternationalAddressController.onSubmit(mode: Mode = NormalMode)" >> ../conf/app.routes

echo "GET        /changeAgentInternationalAddress                  controllers.AgentInternationalAddressController.onPageLoad(mode: Mode = CheckMode)" >> ../conf/app.routes
echo "POST       /changeAgentInternationalAddress                  controllers.AgentInternationalAddressController.onSubmit(mode: Mode = CheckMode)" >> ../conf/app.routes
...
echo "agentInternationalAddress.field1 = field1" >> ../conf/messages.en
echo "agentInternationalAddress.field2 = field2" >> ../conf/messages.en
...
awk '/class/ {\
     ...
     print "    x =>";\
     print "      AnswerRow(";\
     print "        HtmlFormat.escape(messages(\"agentInternationalAddress.checkYourAnswersLabel\")),";\
